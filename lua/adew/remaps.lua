...
-- Thanks primeagen, moving higlighted sections
...
-- greatest remap ever, thanks primeagen
...
vim.keymap.set('n', '<leader>hh', require('harpoon.ui').toggle_quick_menu, { desc = '[H]arpoon [H]Open' })
